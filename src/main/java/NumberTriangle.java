    ...
    public int retrieve(String path) {
        ...
        for (int i = 0; i < path.length(); i++) {
            ...
            if (dir == 'l') {
                ...
                throw new IllegalArgumentException("Invalid path character: " + dir);
            }

            if (current == null) {
                throw new IllegalArgumentException("Path goes out of bounds: " + path);
            }
        }
        ...
        while (line != null) {
            ...
            if (!levels.isEmpty()) {
                ...
                for (int i = 0; i < prev.size(); i++) {
                    prev.get(i).setLeft(currentLevel.get(i));
                    prev.get(i).setRight(currentLevel.get(i + 1));
                }
            }
